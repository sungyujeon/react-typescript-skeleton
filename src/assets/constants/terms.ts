...
export const TERMS_OF_PRIVACY = `
주)우아한형제들(이하 ‘회사’라 한다)은 개인정보보호법 등 관련 법령에 따라 이용자의 개인정보를 보호하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보 처리방침을 수립하여 공개합니다.
1. 개인정보의 수집·이용
...
● 개인정보침해신고센터 : 홈페이지 : http://privacy.kisa.or.kr | 전화번호 : (국번없이) 118
● 개인정보 분쟁조정위원회	: 홈페이지 : https://www.kopico.go.kr | 전화번호 : 1833-6972
● 대검찰청 사이버수사 : 홈페이지 : http://privacy.kisa.or.kr | 전화번호 : (국번없이) 118
● 개인정보침해신고센터 : 홈페이지 : http://privacy.kisa.or.kr | 전화번호 : (국번없이) 118
12. 고지의 의무
